        ...
        try:
            ...
            while has_more:
                response = self.client.blocks.children.list(
                    block_id=page_id, start_cursor=next_cursor, page_size=100
                )
        ...
        try:
            ...
            for page in response["results"]:
                ...
                capability = {
                    ...
                    "experience": props["Experience"]["rich_text"][0]["text"][
                        "content"
                    ],
                    "examples": (
                        props["Examples"]["rich_text"][0]["text"]["content"]
                        if props["Examples"]["rich_text"]
                        else ""
                    ),
                }
