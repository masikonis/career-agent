...
from ..base.exceptions import StorageError, EntityNotFoundError
...
class MongoDBCompanyStorage(CompanyStorage):
    ...
    def _to_document(self, company: Company) -> Dict:
        ...
        return {
            ...
            'evaluations': [self._evaluation_to_dict(e) for e in (company.evaluations or [])],
    ...
    def _from_document(self, doc: Dict) -> Company:
        ...
        return Company(
            ...
            evaluations=[self._dict_to_evaluation(e) for e in doc.get('evaluations', [])],
